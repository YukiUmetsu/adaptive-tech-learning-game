...
use crate::dto::{
    ...
    DomainProgressDto, EvaluationSliceDto, FamilyConfusionDto, FamilyInsightDto,
    FamilyInsightsResponse, FeedbackResponse, IssueMissionRequest, LearningDomainResponse,
    MeResponse, MissionResponse, MissionReviewResponse, ModelEvaluationResponse, NodeProgressDto,
    ...
    ReconstructionAnswerPayload, ReviewedAttempt, ReviewedQuestion, SeenExampleDto, StreakDto,
...
#[openapi(
    ...
    paths(
        ...
        crate::routes::progress::get_track_family_insights,
    ...
    components(schemas(
        ...
        adaptive_learn_content::FamilyExampleContext,
        adaptive_learn_content::FamilyConfusion,
        adaptive_learn_content::FamilyGuide,
